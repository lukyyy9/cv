...
\cvevent{Alternant Cybersécurité}{Monaco Telecom}{septembre 2025 -- Aujourd'hui}{Monaco}
\begin{itemize}
...
\cvevent{Alternant Développement IT}{Monaco Telecom}{août 2023 -- août 2025}{Monaco}
\begin{itemize}
...
\cvevent{Application de cartographie pour créer des plans intéractifs et les publier en ligne}{Cartonord}{avril 2025 -- août 2025}{Nice, France}
\begin{itemize}
...
\divider\cvevent{Application d'automatisation d'onboarding IT}{Depine}{avril 2024 -- avril 2025}{Nice, France}
\begin{itemize}
    \item Déploiement sur AWS et utilisation de CloudFlare
    \item Automatisation CI/CD
