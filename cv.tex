...
\cvevent{Application d'automatisation d'onboarding IT}{Depine}{avril 2024 -- Aujourd'hui}{Sophia Antipolis}
\begin{itemize}
...
\cvevent{Bot Discord de partage de média}{Distant}{mars 2024}{Sophia Antipolis}
\begin{itemize}
    \item Automatisation CI/CD
...
\cvevent{Hub pour E-sports}{Reave}{octobre 2023 -- janvier 2024}{Sophia Antipolis}
\begin{itemize}
    \item Management agile d'une équipe (SCRUM)
...
\cvevent{Master of Science en Alternance}{Epitech}{2024 -- 2026}{Nice}
...
\cvevent{BUT Informatique en Alternance}{IUT Nice Côte d'Azur}{2021 -- 2024}{Sophia Antipolis}
...
\cvevent{Baccalauréat Scientifique}{Lycée Simone Veil}{2020}{Sophia Antipolis}
